...
import { allSettingsSchema, appSettingsSchema, automationSettingSchema, automationSettingsSchema, customizableMenuSettingsSchema, deviceAuthsSettingsSchema } from '$lib/validations/settings';
